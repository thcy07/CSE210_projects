...
public class CheckListGoal:Goal
{
    ...
    public CheckListGoal(string name , string description , int points, int repsCompleted, int totalReps, int bonusPoints, bool completed ):base( name, description, points, completed)
    {
